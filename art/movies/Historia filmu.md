...
<img src="img/image-20250627182152095.png" alt="image-20250627182152095" style="zoom:67%;" />
...
<img src="img/image-20250627182636781.png" alt="image-20250627182636781" style="zoom:80%;" />
...
<img src="img/image-20250627183736358.png" alt="image-20250627183736358" style="zoom:50%;" />
...
## 1.4 Georges Méliès – ojciec filmowej fantazji i montażu trickowego
...
W ten sposób powstał film [Piękna Lukanida, 1912](Prekrasnaya Lyukanida (1912) The Beautiful Leukanida (Khanzhonkov)) - pierwszy animowany romans z owadami w roli głównej. Odtwarzał ludzkie emocje, dramaty i intrygi w świecie insektów.
...
> **Symultaniczność**  odnosi się do zjawiska jednoczesnego występowania kilku zdarzeń lub procesów, które mogą dziać się w różnych miejscach.
...
Na końcu filmu bandyta strzela w stronę kamery – to słynne przełamanie czwartej ściany. Nie było częścią fabuły, ale **wielu widzów wtedy rzeczywiście odskakiwało z krzeseł**, bo to był szokujący efekt.
...
Tu warto omówić wpływ malarstwa na kino. Bo to od filmu **Film d'Art** się zaczęło. W filmach takich jak ["Zabójstwo księcia Gwizjusza”1908](https://youtu.be/bh0tonXPEKQ?si=adSHqZVPASDaUqJw) reżyserzy komponowali kadry jak obrazy malarskie:
...
📌 Pastrone zastosował to, **zanim zrobił to Griffith** – technika ta weszła potem do klasyki jako „tracking shot”.
...
<img src="img/image-20250627203230562.png" alt="image-20250627203230562" style="zoom:67%;" />
...
- Dzięki **montaż 180°** (zachowanie osi akcji).
...
<img src="img/image-20250627204724188.png" alt="image-20250627204724188" style="zoom:50%;" />
...
<img src="img/image-20250627205005119.png" alt="image-20250627205005119" style="zoom:50%;" />

pierwszy film gangsterski, realizm ulicy.

#### [Narodziny narodu (1915)](https://youtu.be/nknEDVXBfxk?si=lWo6vF2vPaIvjkk0)

<img src="img/image-20250627205244423.png" alt="image-20250627205244423" style="zoom:50%;" />
...
<img src="img/image-20250627205304888.png" alt="image-20250627205304888" style="zoom:50%;" />
...
<img src="img/image-20250627205335735.png" alt="image-20250627205335735" style="zoom:50%;" />
...
![image-20250627210038748](img/image-20250627210038748.png)
...
<img src="img/image-20250627210136070.png" alt="image-20250627210136070" style="zoom:50%;" />
...
<img src="img/image-20250627210716644.png" alt="image-20250627210716644" style="zoom:50%;" />
...
<img src="img/image-20250627212220275.png" alt="image-20250627212220275" style="zoom:50%;" />
...
## 3.3 Film Noir – amerykański cień ekspresjonizmu
...
<img src="img/image-20250627225715889.png" alt="image-20250627225715889" style="zoom:50%;" />
...
> 📌 Noir przeniesiony w realia japońskiego kryzysu i **psychologicznej winy**.
...
<img src="img/image-20250627225327015.png" alt="image-20250627225327015" style="zoom:50%;" />
...
<img src="img/image-20250627225347368.png" alt="image-20250627225347368" style="zoom:50%;" />
...
<img src="img/image-20250627225733238.png" alt="image-20250627225733238" style="zoom:50%;" />
...
## 4.1 Awangarda radziecka – kino jako broń idei
...
>  Tu się przyda kontekst historyczny: Komunizm opierał się na totalnym odrzuceniu religi oraz kapitalizmu. Boga nie ma, a każdy człowiek ma być wolny i równy. Komuniści chcieli sprzedać wizję religii jako mechanizm kontroli i zniewolenia społeczeństwa przez władze kapitalistyczne, które potrzebował niewolników do swoich fabryk i przemysłu. 
...
- Sekwencje montowane **nielinearnie**, w formie **eseju filmowego**.
...
![image-20250628011557639](img/image-20250628011557639.png)
...
<img src="img/image-20250628012525531.png" alt="image-20250628012525531" style="zoom:50%;" />
...
👉 **Co ważne**: Welles – mimo że figuruje jako główny autor – **dzielił kontrolę twórczą** z pozostałymi. Film powstał dzięki **symbiozie trzech osobowości**, co stało się precedensem dla późniejszego rozumienia **kina autorskiego**.
...
<img src="img/image-20250628015954990.png" alt="image-20250628015954990" style="zoom:50%;" />
...
<img src="img/image-20250628020017300.png" alt="image-20250628020017300" style="zoom:50%;" />
...
![image-20250628020108545](img/image-20250628020108545.png)
...
<img src="img/image-20250628020716745.png" alt="image-20250628020716745" style="zoom:50%;" />
...
- **Pokrewieństwo**: Welles i Lang jako twórcy **operowi, totalni**, łączący rozmach wizualny z gorzką diagnozą społeczną.
  ...
  ![image-20250628020654659](img/image-20250628020654659.png)
...
- **Zbieżność**: Reed operuje obrazem i niedopowiedzeniem jak Welles – film często traktowany jako „duchowy krewniak *Kane’a*”.
  ...
  <img src="img/image-20250628020734017.png" alt="image-20250628020734017" style="zoom:50%;" />
...
<img src="img/image-20250628020749205.png" alt="image-20250628020749205" style="zoom:50%;" />
...
- Kamera i montaż przestają tylko „pokazywać”, zaczynają **interpretować i sugerować**.
...
### 📚 **André Bazin – ojciec teorii filmowej**
...
![image-20250628024918815](img/image-20250628024918815.png)
...
👉 Godard **burzy iluzję kina** – przypomina, że to sztuka, nie życie.
...
![image-20250628030013403](img/image-20250628030013403.png)
...
![image-20250628031758736](img/image-20250628031758736.png)
...
![image-20250628032543826](img/image-20250628032543826.png)
...
Współczesne kino z HongKongu - < wypisane filmy >

Kino Polskie - < wypisane filmy >

- **animacja** (*animation*) – każdy proces, w ramach którego wrażenie ruchu zostaje wytworzone w wyniku fotografowania serii rysunków (patrz także: *animacja celuloidowa*, *obiektowa* lub *animacja komputerowa*). Iluzja ruchu zostaje wytworzona dzięki niewielkim różnicom w położeniu, zarejestrowanym klatka po klatce.
- **animacja celuloidowa** (*cel animation*) – tradycyjna animacja wykorzystująca serię rysunków na celuloidzie. Iluzja ruchu uzyskiwana dzięki nieznacznym różnicom między kolejnymi klatkami filmu.
- **auteur** – termin pochodzący z języka francuskiego, odnoszący się do reżysera filmowego, którego osobisty styl lub tematyka są rozpoznawalne w różnych filmach. W szerszym sensie, często jest także używany w wartościującym sensie, w celu określenia dobrych twórców filmowych (*autorów dzieł*), w przeciwieństwie do twórców komercyjnych.
- **CGI – animacja komputerowa** – *computer-generated imagery*, obrazy wygenerowane komputerowo, często w celu wsparcia komputerowo generowaną postacią, scenografii i innymi efektami kadru.
- **cięcie (cut)** – 1) w pracy nad filmem – sposób łączenia ze sobą fragmentów filmu (scen) w jeden filmowy ciąg; 2) w gotowym filmie – gwałtowne przejście od jednego ujęcia do kolejnego.
- **cięcie oszukujące** (*cheat cut*) – w systemie montażu ciągłego cięcie, które łączy ze sobą ujęcia z zachowaniem ciągłości akcji, lecz nie są one zapisane z obiektywnej perspektywy; w ujęciach może zmieniać się lokalizacja aktora, jego pozycja, gesty, mimika lub rekwizyty.
- **czas projekcji** – czas potrzebny do odtworzenia filmu na ekranie. Może różnić się w zależności od zastosowanego sprzętu (*np. zbyt szybki projektor*).
- **czas trwania** (*duration*) – w filmie fabularnym, fabuła filmu przedstawia ciąg zdarzeń w czasie. Czas ten może różnić się od rzeczywistego czasu projekcji i czasu trwania historii, która jest opowiadana. W zależności od zabiegów montażowych czas trwania historii, czasu projekcji i czasu trwania narracji mogą się różnić.
- **częstotliwość (frequency)** – w filmie fabularnym częstotliwość to liczba powtórzeń określonego wydarzenia. Ta sama historia jest czasami przedstawiona kilkukrotnie.
- **detal** (*detail*) – plan filmowy ukazujący dłoń, oko czy część obiektu. Często stosowany do wyeksponowania szczegółu, symbolu lub emocji.
- **diegeza (diegesis)** – świat przedstawiony filmu, przedstawiony opowiadaniem; do diegezy zaliczamy także te zdarzenia, które należą do historii (zakładamy, że się wydarzyły), a które nie zostały pokazane na ekranie. Zobacz także: *dźwięk diegetyczny*, *dźwięk niediegetyczny*.
- **długość ogniskowej** (*focal length*) – długość ogniskowej decyduje o stopniu powiększenia obrazu, a więc o perspektywie zarejestrowanej przez obiektyw. Świetnie nadaje się do zmiany rozmiaru planu. Zobacz także: *obiektyw*, *zoom*.
- **dolly (wózek)** – pod wózek z kamerą ruchomą ramieniem przesuwa się po torach (*jazda*).
- **dubbing (dubbing)** – proces polegający na zastąpieniu na ścieżce dźwiękowej filmu nagranego dialogu w innym języku głosami lektorów. W przypadku pogranicza mówionego i dialogu stosuje się też lektora lub napisy.
- **dystrybucja** (*distribution*) – jedna z trzech głównych dziedzin przemysłu filmowego zajmująca się rozpowszechnianiem gotowego produktu filmowego i zapewnianiem tytułów. Zobacz także: *pokaz*, *produkcja*.
- **dźwięk asynchroniczny** (*asynchronous sound*) – dźwięk, który nie jest czasowo zharmonizowany z obrazem, nie pasuje do niego, gdy dialog nie jest zsynchronizowany z ruchem ust.
- **dźwięk bezpośredni** (*direct sound*) – muzyka, odgłosy i dialogi zarejestrowane podczas filmowania, w przeciwieństwie do dźwięku postsynchronowego.
- **dźwięk diegetyczny** (*diegetic sound*) – każdy dźwięk, który mógłby lub efektywnie wydaje się pochodzić z przestrzeni fabularnej świata filmu (*np. radio grające w scenie*).
- **dźwięk niediegetyczny** (*nondiegetic sound*) – dźwięk pochodzący spoza przestrzeni opowiadania, np. nastrojowa muzyka, komentarz narratora.
- **dźwięk niesymultaniczny** (*nonsimultaneous sound*) – dźwięk, który pochodzi z przeszłości lub przyszłości względem wydarzeń w obrazie (*np. retrospekcje lub przemyślenia bohatera*).
- **dźwięk symultaniczny** (*simultaneous sound*) – dźwięk towarzyszący wydarzeniom w tym samym czasie, co czas fabularny historii, towarzyszący mu obraz.

- **dźwięk synchroniczny** (*synchronous sound*) – dźwięk, który w czasie do ruchu mającego miejsce na ekranie, np. gdy dialog odtwarzany pasuje do ruchu ust postaci.
- **dźwięk z offu** (*offscreen sound*) – dźwięk pochodzący z poza kadru, pochodzący z czasu i przestrzeni widocznego na ekranie, ale nie z miejsca aktualnie zarejestrowanego przez kamerę. Jest to jeden z dźwięków niediegetycznych. Zobacz także: *dźwięk diegetyczny*, *dźwięk niesymultaniczny*.
- **dźwięk zza kadru** (*sound over*) – dźwięk symultaniczny ze źródłem, które – jak zakładamy – znajduje się w przestrzeni sceny, ale nie jest widoczne na ekranie.
- **efekty specjalne** (*special effects*) – ogólny termin określający różne manipulacje obrazem, za pomocą których zostają zniekształcone lub udziwnione obrazy, np. pokazanie obiektu UFO. Używa się do tego animacji, zdjęć poklatkowych, zdjęć optycznych, a ostatnio – komputerowych (*CGI*).
- **elipsa czasowa** (*ellipsis*) – w filmie fabularnym, skrócenie czasu trwania fabuły poprzez pominięcie części trwania historii. Zobacz także: *montaż oszczędny*, *czas projekcji*.
- **fabuła (plot)** – w filmie fabularnym, wszystkie zdarzenia, które zostały nam bezpośrednio przedstawione na ekranie, włącznie z łączącymi je elementami narracyjnymi. Chronologicznie czasem trwania oraz umiejscowieniem w przestrzeni różni się od historii, która jest wyobrażeniem przez widza kontekstu, składającego się ze zdarzeń widzianych i niewidzianych. Zobacz także: *historia*, *czas rzeczywisty*, *czas trwania*, *czas projekcji*.
- **film noir** – termin odnoszący się do pewnych typów filmów francuskich krytyków z lat 40. XX wieku: kryminały amerykańskie, z pesymistyczną fabułą, mroczną atmosferą, dużym nasyceniem światła i cienia oraz często kobiecym kusicielem (*femme fatale*). Bohater z reguły cyniczny i nie-moralny.
- **filtr** – szklane lub żelatynowe nakładki nakładane na obiektyw kamery lub kopie filmu w celu zmniejszenia ilości światła, koloru lub nasycenia.
- **forma (form)** – całościowy system relacji zachodzących między elementami filmu.
- **forma abstrakcyjna** (*abstract form*) – typ organizacji filmu, w którym jego części zostały zorganizowane zgodnie z rytmem, ruchem, kolorem, kształtem, linią i ruchem, a nie z opowiadaniem historii.
- **forma asociacyjna (associational form)** – typ organizacji filmu, w którym zestawia się różne obrazy na zasadzie skojarzeń w celu osiągnięcia określonego efektu.
- **forma kategoryjalna (categorical form)** – typ organizacji, w której części odnoszą się do różnych składników danego tematu. Na przykład film o Stanach Zjednoczonych może zostać podzielony na 50 części, z których każda byłaby poświęcona jednej z 50 części (*stanów*).
- **forma narracyjna – fabularna** (*narrative form*) – typ organizacji dzieła filmowego, w której części są ze sobą powiązane serią przyczynowo-skutkowych zdarzeń z postaciami działającymi w określonym czasie i w przestrzeni.
- **forma retoryczna (rhetorical form)** – typ organizacji filmu, w której celem jest dostarczenie argumentów na poparcie określonej tezy.
- **format akademii** (*academy ratio*) – format obrazu kinowego wprowadzony przez Amerykańską Akademię Sztuki i Wiedzy Filmowej. Początkowo szerokość klatki filmowej wynosiła 1.33:1, później została skorygowana przez wprowadzenie tzw. „maski akademickiej” i obecnie jej stosunek to 1.85:1 w USA.
- **format filmu – wymiary, szerokość filmu** (*gauge*) – szerokość taśmy filmowej mierzona w milimetrach.
- **format obrazu** (*aspect ratio*) – stosunek szerokości kadru filmowego do jego wysokości. Standardowy *format akademii* jest określany jako 1.85:1, a inny często spotykany format to 2.35:1.
- **funkcja (function)** – rola spełniana przez pojedynczy element w całości filmu, np. przez kadr, ujęcie, znak itp.
- **futurospekcja (flashforward)** – zabieg narracyjny, w którym wydarzenie przyszłe pokazane jest na ekranie przed wydarzeniami wcześniejszymi. Przeważnie ma to na celu przedstawienie zdarzenia, którego znaczenie nie zostało jeszcze całkowicie wyjaśnione.
- **gatunki filmowe** (*genres*) – różne rodzaje filmów, rozpoznawalne i zrozumiałe zarówno przez widzów, jak i twórców, ze względu na zestaw typowych cech tematycznych, stylu i środków wyrazu. Przykłady: m.in. *musical*, *film gangsterski*, *komedia romantyczna*.
- **głębia ostrości** (*depth of field*) – strefa (zakres odległości), w której obiekty pozostają ostre. Przy małej przysłonie (np. 2.8) głębia ostrości będzie płytka. Przy dużej (np. 11) – głęboka. Typowe zakresy to 4.5 m oraz 4.5 m odległości – za wszystko, co znajduje się w tym zakresie, będzie ostre.
- **głębia przestrzeni – głęboka kompozycja** (*deep space*) – układ przestrzenny elementów sceny, w której pomiędzy pierwszym a drugim planem znajduje się znaczna odległość, co tworzy efekt głębi. Widz ma poczucie trójwymiarowości, a dzięki użytym dystansom, jak szerokokątny obiektyw – efekt ten się pogłębia.
- **granica kadrowania graficzna** – granica pomiędzy dwoma obiektami w kadrze przypominającymi lub spójnymi pod względem koloru, kompozycji, kształtu lub lokalizacji.

- **harmonizowanie linii wzroku – montaż oparty na punkcie widzenia** (*eyeline match*) – sposób montowania scen, w którym przestrzegana jest zasada 180° i nie przekracza się osi akcji; w montażu opartym na punkcie widzenia pierwsze ujęcie przedstawia postać patrzącą poza kadr, a drugie to, na co patrzy. Jeśli ujęcie pokazuje przestrzeń zewnętrzną kadru, to postać widziana w pierwszym ujęciu pozostaje przy tej linii, gdzie wcześniej była; spojrzenie, które patrzy znajduje się poza kadrem pod tym samym kątem.
- **historia** (*story*) – w filmie fabularnym, zbiór wszystkich zdarzeń przedstawionych bezpośrednio na ekranie, jak i tych, które zakładamy, że się zdarzyły, mimo że nie były zaprezentowane. Zobacz też: *fabuła*, *czas trwania*, *czas projekcji*, *czas narracji*, *czas rzeczywisty*.
- **ideologia** (*ideology*) – względnie spójny system wartości, poglądów i sądów podzielanych przez daną grupę społeczną. W filmie może przejawiać się przez cechy wizualne, wpisując z natury lub nieświadomie w ideologiczne przesłanie.
- **interpretacja** (*interpretation*) – aktywność widza polegająca na analizowaniu implikacyjnych i symptomatycznych znaczeń zasugerowanych w filmie.
- **kadrowanie** (*framing*) – zastosowanie ram kadru w celu wybrania i zakomponowania tego, co będzie widoczne na ekranie.
- **kadrowanie w ruchu – ruchomy kadr** (*mobile frame*) – efekt uzyskany na ekranie w wyniku poruszania się kamery – zastosowania obiektywu ze zmienną ogniskową (*zoom*) lub w wyniku ruchu kamery. Ruchoma kamera kadruje obraz w inny sposób niż klasyczne cięcie. Zobacz też: *ujęcie z kranu, panoramę, najazd, jazdę*.
- **kamera z ręki** (*hand-held camera*) – wykorzystanie ciała operatora jako statywu kamery.
- **kaszeta** (*mask*) – ciemna osłonka umieszczana na kamerze lub kopiatorce, która zasłania część klatki filmowej i zmienia jej proporcje (np. zmienia 4:3 do 1:1,85). Kaszeta może też odnosić się do efektu czarnego paska u góry i dołu ekranu lub po jego bokach (*letterboxing*), zdarza się też, że jest ona używana jako walor wizualny.
- **kąt kamery (kąt ujęcia)** – pozycja kamery (kądu) względem postaci w kadrze lub obiektu. Kiedy kamera znajduje się na wysokości oczu filmu, patrząc na postać klasycznie, realizuje się ujęcie neutralne. Kiedy umieszczona jest wyżej – może przedstawiać obiekt z góry (kąt wysoki); albo może przedstawiać obiekty z dołu (kąt niski).
- **kierunek ekranowy** (*screen direction*) – relacje przestrzenne (prawo-lewo) w obrębie sceny, ustalone w ujęciu inaugurującym, a później konsekwentnie utrzymywane w kadrach, ujęciach, ruchu i akcie. W trakcie montażu, zmiana kierunku ekranowego może prowadzić do zagubienia widza. Zobacz również: *oś akcji, harmonizowanie linii wzroku*.
- **klatka filmowa** (*frame*) – pojedynczy obraz w klasie filmowej. Setki klatek wyświetlane na ekranie w szybkim tempie, wytwarzają iluzję ruchu.
- **kompozycja** (*mise-en-scène*) – w obrazie filmowym, rozłożenie najważniejszych elementów w kadrze filmu.
- **kontrola ruchu (motion control)** – komputerowa metoda rejestrowania i manipulowania ruchem kamery, modeli, miniatur i innych wyposażonych w silniki w realizacji zdjęć specjalnych i efektów wizualnych.
- **linearność** (*linearity*) – kiedy w opowiadaniu mamy do czynienia z jednym ciągiem przyczynowo-skutkowym, w którym zdarzenia zachodzą bez odchyleń, opóźnień lub alternatywnych zdarzeń.
- **long take** – ujęcie trwające wyjątkowo długo, zanim nastąpi cięcie (*długi master shot*).
- **miksowanie** (*mixing*) – łączenie dwóch lub więcej ścieżek dźwiękowych w jedną.
- **mise-en-scène – inscenizacja** – wszystkie elementy przestrzenne kadrów: scenografia, rekwizyty, oświetlenie, kostiumy i charakterystyka postaci, ruchy postaci.
- **montaż (editing)** – 1) w pracy nad filmem – proces łączenia ujęć, dźwięków i efektów specjalnych w całość; 2) w gotowym filmie – zauważalne połączenie kadrów, zazwyczaj zmontowanych zgodnie z zasadą ciągłości (*montaż ciągły*).
- **montaż „na zakładkę”** (*overlapping editing*) – montaż, w którym część drugiego ujęcia pokazuje ponownie końcowy moment ujęcia wcześniejszego (*np. postać wychodząca z kadru*).
- **montaż ciągły** (*continuity editing*) – konwencjonalny styl montażu, w którym zakłada się zachowanie ciągłości przestrzeni i czasu oraz relacji ekranowych (*prawo-lewo, plan/kontrplan, kąt kamery*). W ujęciach nie występują błędy czasoprzestrzenne, nie gubimy kierunku akcji, ułożenia postaci itd. Zobacz też: *montaż „na zakładkę”, kierunek ekranowy, plan/kontrplan*

- **montaż eliptyczny** (*elliptical editing*) – taki sposób montowania ujęć, który prowadzi do pominięcia części zdarzeń i wytworzenia elips czasowych w czasie trwania fabuły.
- **montaż intelektualny** (*intellectual montage*) – montaż polegający na zderzaniu ze sobą serii obrazów, co prowadzi do powstania abstrakcyjnych idei, niezwiązanych z osobą w żadnym pojedynczym obrazie.
- **montaż na ruchu – cięcie na akcji** (*match on action*) – w montażu ciągłym, cięcie, które łączy dwa różne ujęcia tej samej akcji; w tym samym momencie ruchu, harmonizując taką ciągłość wrażeń wzrokowych. Jest to sposób akcji, która rozpoczyna się w jednym ujęciu, jest kontynuowana lub kończy się w ujęciu następnym.
- **montaż nieciągły** (*discontinuity editing*) – każdy alternatywny sposób montażu, wykorzystujący techniki sprzeczne z zasadą ciągłości (ciągłego montażu). Możemy do nich zaliczyć elipsę czasową, montaż intelektualny, montaż równoległy, montaż graficzny, skupienie się nie na logice akcji, skupienie się bardziej na rytmie, zestawieniach formalnych. Zobacz także: *montaż eliptyczny, montaż intelektualny, montaż równoległy, harmonizowanie graficzne, montaż na zakładkę, montaż niesymultaniczny, wstawka niediegotyczna, montaż na zakładkę*.
- **montaż równoległy** (*crosscutting*) – rodzaj montażu pozwalający za pomocą przeplatania ujęć na przedstawienie dwóch lub więcej wątków akcji, które dzieją się w innych miejscach, jednak zazwyczaj w tym samym czasie.
- **motyw** (*motif*) – element filmu powtarzany w znaczący sposób.
- **motywacja** (*motivation*) – zawarte w filmie uzasadnienie dla obecności danego elementu. Może się odwoływać od wiedzy widza na temat rzeczywistości pozafilmowej, czy przyczynowości narracyjnej, znajomości konwencji gatunkowych, albo wzorów stylistycznych widocznych w filmie.
- **nachodzenie planów** (*overlap*) – wskaźnik sugerujący głębię przestrzeni obrazu filmowego, polegający na umieszczeniu jednego elementu przed drugim.
- **nakładanie dialogów** (*dialogue overlap*) – w montażu sceny, takie zaaranżowanie przejścia między ujęciami, które zakłada, że fragment dialogu z ujęcia A pojawia się jeszcze w ujęciu B, przedstawiającym inną postać lub inny element sceny. Daje to wrażenie planu, przerywanego przez cięciem.
- **narracja** (*narration*) – proces, poprzez który *fabuła* przekazuje *informację o historii* albo ujawnia zdarzenia w historii. Styl narracji może być różny: może być *wszechwiedzący* lub *ograniczony*, *bardziej obiektywny* lub *subiektywny*, *linearny* lub *nielinearny*. Film może również różnić się w różnych stopniu ujawnianiem motywacji bohatera.
- **naświetlenie – ekspozycja** (*exposure*) – ilość światła padającego na każdą klatkę filmu, regulowana poprzez ustawienie w kamerze wartości przysłony i czasu naświetlania.
- **niski klucz oświetleniowy** (*low-key lighting*) – styl oświetlenia charakteryzujący się dużym kontrastem i ciemnością. Służy do uzyskania nastrojowego, ekspresyjnego klimatu (*typowy w filmach noir*). Źródło światła jest ostre, a światło wypełniające zredukowane lub nieobecne, co powoduje efekt *chiaroscuro* (światłocień), polegający na mocnym kontraście światła i ciemności widocznej na obrazie.
- **obiektyw anamorficzny** (*anamorphic lens*) – obiektyw przeznaczony do rejestracji obrazu panoramicznego na taśmie filmowej o klasycznym formacie (np. 35mm z maską akademii). Obiektyw ten ściska obraz w poziomie w czasie rejestracji, a następnie rozszerza go anamorficzny obiektyw w czasie kopiowania. Zastosowanie pozwala uzyskać panoramiczny obraz bez zmniejszania jakości optycznej i bez kadrowania obrazu.
- **obiektyw standardowy** (*normal lens*) – obiektyw, który przedstawia filmowane obiekty bez zauważalnych zniekształceń, bez wyraźnego zwiększania lub redukowania głębi planu. Dla formatu filmu 35 mm długość ogniskowa obiektywu mieści się w przedziale od 35 mm do 50 mm.
- **obiektyw szerokokątny** (*wide-angle lens*) – obiektyw o krótkiej ogniskowej, mający zdolność obejmowania szerokich kadrów i silnego zbliżenia brzegów kadru, zakrzywia te brzegi (*beczkowanie*). Wzmacnia głębię ostrości, więc często stosowany w scenach z większą głębią. Obiekty bliskie planu są wyolbrzymione względem dalszych. W filmie 35mm długość ogniskowej takiego obiektywu wynosi 35 mm lub mniej. Zobacz także: *głębia ostrości, głębia przestrzeni*.
- **obiektyw zoom** (*zoom lens*) – obiektyw pozwalający na zmianę długości ogniskowej w trakcie ujęcia. Im bliżej jest obraz, tym ciaśniejsze pole widzenia, co często stosuje się jako zabieg dramatyczny. W przeciwieństwie do kamery, która fizycznie przybliża się lub oddala od obiektu, zoom nie zmienia relacji przestrzennych między obiektami – dlatego nie powoduje *paralaksy*, więc nie daje *szerokokątnego* wrażenia głębi.
- **obraz monochromatyczny** (*monochromatic color design*) – rodzaj kolorystyki, w którym używana jest tylko jedna barwa w różnych odcieniach.
- **ostre światło** (*hard lighting*) – światło, które wyraźnie wyznacza cień, ma twardą krawędź i ostre krawędzie.
- **oś akcji** (*axis of action*) – w systemie montażu ciągłego zasada organizacji cięcia akcji poprzez postać znajdującą się w ruchu. Wyobrażona linia (oś), która dzieli przestrzeń na dwie strony – postać pozostaje po tej samej stronie względem wszystkich elementarnych scen, określająca jej kierunek ruchu.

- **oświetlenie boczne** (*side lighting*) – światło padające na postać lub przedmiot z boku, podkreślające strukturę przestrzenną przedmiotu lub postaci, wydobywając kontury i tekstury, podkreślając szczegóły.
- **oświetlenie dolne** (*underlighting*) – światło wypływające z punktu znajdującego się poniżej postaci występujących w scenie.
- **oświetlenie górne** (*top lighting*) – światło rzucane z góry, pochodzące ze źródła umieszczonego nad postacią.
- **oświetlenie trójpunktowe** (*three-point lighting*) – najpowszechniejsze światło oświetlające scenę z trzech różnych kierunków: składa się na nie światło kontrowe, światło rzucane zza postaci, jasne światło wypełniające oraz miękkie, jasne światło wypełniające, równoważące światło główne.
- **panorama** (*pan*) – ruch kamery w poziomie bądź pionie (przy użyciu bez zmiany lokalizacji kamery), podczas którego kamera się obraca. *Panorama pozioma* to obrót kamery na osi w linii poziomej (lewa–prawa), *panorama pionowa* to obrót na osi pionowej (góra–dół). Wygląda to tak, jakby kamera podnosiła „głowę” w górę lub opuszczała ją w dół.
- **pełna głębia ostrości** (*deep focus*) – takie ustawienie parametrów obiektywu kamery i oświetlenia, które pozwala na utrzymanie w pełni ostrej zarówno części obiektu znajdujących się na pierwszym, jak i dalszym planie.
- **perspektywa dźwięku** (*sound perspective*) – wrażenie przestrzenne dźwięku (odległość, źródło dźwięku), wynikające ze stosunku poziomu głośności, jego barwy, pogłosu, a także efektu czasu i otwarcia stereofonicznego.
- **perspektywa powietrzna** (*aerial perspective*) – wskaznik sugerujący głębię obrazu poprzez przedstawienie obiektów w oddali w nieco chłodniejszych barwach i mniej wyraźnie. Typowo używana w zdjęciach plenerowych z silnymi i niewyraźnymi planami dalszymi.
- **perspektywa ukośna** (*canted framing*) – sposób kadrowania, w którym pozioma linia w obrazie nie jest równoległa do dolnej krawędzi kadru. Obiekty wydają się przechylać, a cała scena traci stabilność, co wzmaga uczucie niepokoju.
- **pikselacja** (*pixilation*) – forma animacji poklatkowej, w której ruch obiektów trójwymiarowych, ludzi (często także lalek), rejestrowany jest klatka po klatce. Postacie są fotografowane w serii kolejnych zdjęć ruchu zatrzymanych w pozycji.
- **plan amerykański** (*plan średni*) – sposób kadrowania, w którym dolna krawędź kadru wypada na wysokości ud postaci.
- **plan filmowy – rodzaj kadru** (*film shot*) – wyróżnia się różne plany filmowe, definiowane na podstawie odległości obiektu głównego. Zobacz także: *detal, plan bliski, plan ogólny, plan totalny, plan amerykański, plan średni, plan/kontrplan*.
- **plan ogólny** (*long shot*) – sposób kadrowania, w którym obiekt widoczny jest w całości, z większej odległości; często ukazuje postać ludzką od stóp do głów.
- **plan średni** (*medium shot*) – sposób kadrowania, w którym obiekt widoczny jest w całości lub w połowie; postać człowieka ukazana od pasa w górę, zajmuje w tym planie większość kadru.
- **plan totalny** (*extreme long shot*) – plan, w którym przedstawiony obiekt widoczny jest z bardzo daleka, ukazujący całość sceny lub pejzażu, ludzi lub obiektów wtopionych w przestrzeń.
- **plan/kontrplan – ujęcie/przeciwujęcie** (*shot/reverse-shot*) – dwa ujęcia (lub więcej) montowane ze sobą na zasadzie przeciwstawnej pozycji kamery. Zazwyczaj używane w scenach rozmowy. W *montażu na zasadzie osi* pokazuje się każdą postać z tej samej strony, w drugim ujęciu postać patrzy zza ramienia.
- **płytka kompozycja przestrzeni** (*shallow space*) – inscenizacja akcji na niewielu planach względem kadru, z niewielką głębią ostrości.
- **pokazy** – projekcja dla publiczności (*exhibition*) – jeden z trzech głównych elementów przemysłu filmowego (obok produkcji i dystrybucji), obejmuje wszystkie formy prezentacji filmów widowni. Zobacz także: *dystrybucja, produkcja*.
- **pomost dźwiękowy** (*sound bridge*) – 1) na początku sceny, dźwięk z poprzedniej sceny jest słyszany w kolejnej jeszcze przed jej rozpoczęciem; 2) na końcu sceny – dźwięk z kolejnej sceny pojawia się, zanim jeszcze widzimy jej obraz. Typowy zabieg w stylu klasycznym, służący zespoleniu scen w sposób „niewidzialny”, płynny i nienarzucający się.
- **porządek** (*order*) – w filmie fabularnym cecha określająca relację pomiędzy kolejnością zdarzeń w historii i narracji. *Porządek narracji* może zostać odwrócony względem *porządku historii* stosując np. *futurospekcję* lub *retrospekcję*.

- **postsynchronizacja** (*postsynchronization*) – proces dodawania dźwięku do obrazów po ich nakręceniu i zmontowaniu. W jej ramach może odbywać się nagranie dubbingu głosu, efektów dźwiękowych lub muzyki. Przeciwieństwo *dźwięku bezpośredniego*.
- **półzbliżenie** (*medium close-up*) – sposób kadrowania, w którym skala obiektu widocznego na ekranie jest dość duża: postać człowieka, widziana od klatki piersiowej w górę, zajmuje w takim planie większość kadru.
- **produkcja** (*production*) – jeden z trzech głównych etapów przemysłu filmowego; proces tworzenia filmu. Zobacz także: *dystrybucja, pokazy*.
- **przebitka – wcinaka** (*cut-in*) – krótkie ujęcie wklejone pomiędzy ujęcia odpowiadające scenie, często z oddalonego planu do bliższego, przedstawiające istotny szczegół, np. rękę, twarz.
- **przednia projekcja** (*front projection*) – technika, w której obraz tła (np. pejzaż) jest rzutowany na ekran umieszczony za aktorami lub obiektem, który filmujemy. Dzięki zastosowaniu półprzepuszczalnego lustra i odpowiedniego kąta, aktorzy wydają się znajdować w otoczeniu tego obrazu. Przeciwieństwo *projekcji tylnej*.
- **przekadrowywanie** (*reframing*) – korekta ruchu kamery, zazwyczaj po panoramie, mająca na celu utrzymanie postaci lub obiektu w centralnym punkcie kadru.
- **przenikanie** (*dissolve*) – płynne przejście między dwoma ujęciami, w którym jedno zanika, a drugie stopniowo się pojawia. Efekt nakładających się na siebie obrazów.
- **przenoszenie ostrości** (*racking focus*) – technika przesuwania ostrości z jednego obiektu w kadrze na inny, by skierować uwagę widza na nowy element sceny.
- **przeskok montażowy** (*jump cut*) – eliptyczne cięcie, które zakłóca ciągłość obrazu, sprawiając wrażenie „skoku” w czasie lub przestrzeni. Często stosowane celowo dla uzyskania efektu niepokoju, napięcia lub zaburzenia rytmu. Zobacz także: *cięcie oszukujące, montaż nieciągły*.
- **przestrzeń** (*space*) – jedno z podstawowych pojęć w filmie. Odnosi się zarówno do przestrzeni trójwymiarowej w kadrze (kompozycja, głębia, ustawienie obiektów), jak i do przestrzeni narracyjnej – świata przedstawionego filmu. Przestrzeń może być:
  - **ekranowa** – widoczna w kadrze,
  - **pozakadrowa** – poza widocznym kadrem, ale sugerowana dźwiękiem lub wzrokiem postaci,
  - **fabularna** – świat przedstawiony historii, nawet jeśli nieukazany na ekranie.
- **przestrzeń pozakadrowa** (*offscreen space*) – przestrzeń filmowa niewidoczna w danym momencie kadrowania, ale sugerowana przez zachowanie postaci, dźwięki lub układ spojrzeń. Zobacz też: *przestrzeń*.
- **przysłona** (*iris*) – ruchoma, okrągła przesłona, która otwiera się lub zamyka, odsłaniając lub zasłaniając kadr. Klasyczny zabieg kończący sceny w kinie niemym (*zamykanie irysowe*).
- **redukcja rozmiaru** (*scale reduction*) – zabieg wizualny pokazujący obiekty jako mniejsze niż w rzeczywistości, np. przez użycie makiety.
- **retrospekcja** (*flashback*) – przedstawienie wcześniejszych wydarzeń niż obecna akcja filmu. Używane dla nadania kontekstu, wyjaśnienia przeszłości bohatera lub fabularnego zwrotu.
- **roletka** (*wipe*) – przejście między ujęciami, w którym nowe ujęcie „wypycha” poprzednie z ekranu poprzez poziomy, pionowy lub inny graficzny efekt.
- **rotoskopia** (*rotoscoping*) – animacyjna technika, w której rysuje się klatka po klatce na podstawie uprzednio zarejestrowanego materiału filmowego z aktorami. Pozwala uzyskać bardzo realistyczny ruch postaci w animacji.
- **rytm** (*rhythm*) – odczuwalne tempo i regularność ujęć, cięć i wydarzeń w filmie. Może być szybki, powolny, nieregularny itd. Rytm wpływa na emocjonalny odbiór filmu.
- **scena** (*scene*) – podstawowa jednostka kompozycyjna w filmie, zwykle składająca się z kilku ujęć dziejących się w jednej lokalizacji i czasie. Sceny oddzielone są zwykle zmianą miejsca lub czasu akcji.
- **segmentacja** (*segmentation*) – analiza struktury filmu poprzez wyodrębnienie logicznych części narracyjnych, np. aktów, sekwencji, scen.
- **sekwencja** (*sequence*) – jednostka dramaturgiczna większa niż scena, składająca się z ciągu powiązanych tematycznie scen. Często prowadzi do punktu zwrotnego w fabule.
- **sekwencja montażowa** (*montage sequence*) – zestaw krótkich ujęć przedstawiających rozwój wydarzeń w czasie, np. trening postaci, podróż, budowa czegoś, pokazany skrótowo i symbolicznie.

- **soczewka** (*lens*) – optyczne urządzenie z przezroczystego materiału (szkła, plastiku), które skupia lub rozprasza światło, tworząc obraz. W kamerach i projektorach odpowiada za ostrość i charakterystykę obrazu (np. głębię ostrości, zniekształcenia).
- **spójność (unity)** – stopień, w jakim wszystkie elementy filmu są ze sobą zharmonizowane, tworząc logiczną i znaczeniową całość. Wysoka spójność to cecha klasycznego stylu narracyjnego.
- **storyboard** – sekwencja rysunków obrazujących kolejne ujęcia filmu. Używana na etapie planowania zdjęć do wizualizacji kompozycji, ruchu kamery, efektów specjalnych itp.
- **styl (style)** – zestaw powtarzających się środków wyrazu filmowego (kadrowanie, montaż, kolorystyka, dźwięk) stosowanych przez twórcę, nurt lub epokę.
- **system 180°** – zasada montażu, w której kamera nie powinna przekraczać osi akcji (linii między dwiema postaciami), aby zachować spójność przestrzenną. Przekroczenie osi może dezorientować widza.
- **szwenk (whip pan)** – szybki ruch kamery poziomy (lub pionowy), często stosowany do dynamicznego przejścia między scenami lub jako efektowny zabieg formalny.
- **ściemnianie/rozjaśnianie (fade)** – stopniowe pojawianie się lub zanikanie obrazu (albo dźwięku). Może być czarne (fade to black) lub z/do bieli, albo między ujęciami (fade in/out).
- **światło miękkie** (*soft lighting*) – światło dające łagodne cienie i niski kontrast. Zazwyczaj uzyskiwane przez rozproszenie źródła światła (np. przez dyfuzję).
- **światło przednie (front lighting)** – światło padające na obiekt od strony kamery, oświetlające twarz w sposób równomierny i „płaski”.
- **światło rysujące – podstawowe** (*key light*) – główne źródło światła w scenie, definiujące kształty i kierunek oświetlenia. Ustawiane zazwyczaj z boku i powyżej postaci.
- **światło tylne – kontrowe** (*backlighting*) – światło padające zza obiektu w stronę kamery, tworzące kontur i separujące postać od tła.
- **światło wypełniające – dodatkowe** (*fill light*) – dodatkowe źródło światła zmniejszające kontrast cieni rzuconych przez światło główne. Często umieszczone po stronie przeciwnej niż *key light*.
- **taśma filmowa** (*film stock*) – materiał światłoczuły (celuloidowy lub plastikowy), na którym rejestrowany jest obraz w kamerach analogowych. Wyróżnia się różne formaty (np. 8 mm, 16 mm, 35 mm).
- **teleobiektyw** (*telephoto lens*) – obiektyw o długiej ogniskowej, dający duże przybliżenie. Zmniejsza głębię ostrości i „spłaszcza” przestrzeń. Typowe ogniskowe: 75 mm i więcej.
- **tempo** (*pace*) – szybkość narracyjna filmu, rytm montażu, długość ujęć, tempo dialogów. Wpływa na odbiór emocjonalny i dynamikę filmu. Może być szybkie (np. kino akcji) lub powolne (np. dramaty psychologiczne).
- **tyczka (boom)** – wysięgnik do mikrofonu używany podczas nagrań dialogów, umożliwia rejestrację dźwięku blisko aktora, bez widoczności mikrofonu w kadrze.
- **tylna projekcja** (*rear projection*) – technika, w której obraz tła (np. pejzażu) wyświetlany jest za aktorami, nagrywanymi na pierwszym planie. Pozwala łączyć scenę z tłem bez efektów cyfrowych.
- **typaż (typecasting)** – obsadzanie aktorów w rolach zgodnych z ich fizycznością, wcześniejszymi rolami lub stereotypami (np. „twardziel”, „matka Polka”). Może ograniczać różnorodność ról aktora.

- **ujęcie** (*shot*) – fragment filmu zarejestrowany od momentu włączenia do wyłączenia kamery. Może być krótki (np. ujęcie zbliżeniowe) lub długi (tzw. master shot). To podstawowa jednostka montażu filmowego.
- **ujęcie kombinowane z użyciem maski** (*matte shot*) – ujęcie, w którym część obrazu (zazwyczaj tło) została dodana później, osobno zarejestrowana i połączona z aktorami np. w procesie *reprojekcji*.
- **ujęcie powtórnie ustanawiające** (*reestablishing shot*) – ujęcie szerokie używane po serii bliższych planów, aby przypomnieć przestrzenne relacje między postaciami i otoczeniem.
- **ujęcie reprojekcyjne** (*process shot*) – ujęcie, które łączy różne obrazy w jeden, np. przez *projekcję tylną*, *przednią* lub *maski*. Pozwala np. filmować aktorów w studiu z projekcją tła.
- **ujęcie ustanawiające** (*establishing shot*) – ujęcie początkowe sceny pokazujące lokalizację, relacje przestrzenne między postaciami i otoczeniem.
- **ujęcie z jazdy** (*tracking shot*) – ujęcie, w którym kamera porusza się względem sceny w przód, tył lub bok. Często używane do śledzenia postaci.
- **ujęcie z kranu** (*crane shot*) – ujęcie wykonywane z kamery zamontowanej na ruchomym ramieniu (*kranie*), umożliwiające ruch w pionie i poziomie.
- **ujęcie z punktu widzenia (POV)** (*point-of-view shot*) – ujęcie pokazujące świat z perspektywy danej postaci, tak jakby kamera „patrzyła jej oczami”.
- **ujęcie-sekwencja** (*plan-séquence*) – długa sekwencja filmowa nakręcona w jednym ujęciu, bez montażu.
- **ustawienie frontalne** (*frontality*) – ustawienie postaci lub obiektu dokładnie przodem do kamery.
- **wariacja – zmienność** (*variation*) – powtórzenie elementu filmu w zmienionej formie (np. powracający dźwięk, ale z innym efektem emocjonalnym).
- **wewnętrzny dźwięk diegetyczny** (*internal diegetic sound*) – dźwięk słyszany przez postać (np. głosy w jej głowie), który należy do świata filmu.
- **wstawka niediegetyczna** (*nondiegetic insert*) – ujęcie niepochodzące ze świata przedstawionego (np. symboliczne, ilustracyjne), dodane dla kontrastu lub komentarza.
- **wysoki klucz oświetleniowy** (*high-key lighting*) – styl oświetlenia z dominującym światłem wypełniającym, dającym jasny, miękki obraz bez mocnych cieni.
- **wysokość kamery** (*height of framing*) – fizyczna wysokość kamery względem filmowanego obiektu (np. poziom oczu, z góry, z dołu).
- **zamknięcie/rozwiązanie** (*closure*) – moment w filmie fabularnym, w którym wszystkie wątki zostają rozwiązane, a historia domknięta.
- **zbliżenie** (*close-up*) – ujęcie bliskiego planu (np. twarzy, dłoni), często używane do pokazania emocji lub detali.
- **zdjęcia nakładane** (*superimposition*) – technika polegająca na nałożeniu jednej warstwy obrazu na drugą (np. dwie twarze widoczne jednocześnie, scena wspomnienia).
- **zewnętrzny dźwięk diegetyczny** (*external diegetic sound*) – dźwięk należący do świata filmu i słyszany przez postaci oraz widzów (np. rozmowa, dźwięki otoczenia).
- **znaczenie** (*meaning*) – interpretacja, jaką nadajemy filmowi. Może być:
  1. **referencyjne** – związane z fabułą i treścią,
